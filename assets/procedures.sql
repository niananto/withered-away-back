...
-- 	SELECT NAME, GENDER, BIRTHDAY, EMERGENCY_CONTACT_NO
-- 	INTO P_NAME, P_GENDER, P_BIRTHDAY, P_EMERGENCY_CONTACT_NO
...
-- 	(ID, NAME, GENDER, BIRTHDAY, EMERGENCY_CONTACT_NO, HEIGHT, WEIGHT, BLOOD_GROUP, VACCINE, DISABILITY, HEALTH_CONDITION, ALLERGY, DOCTOR_ID)
-- 	VALUES
-- 	(P_ID, P_NAME, P_GENDER, P_BIRTHDAY, P_EMERGENCY_CONTACT_NO, H_HEIGHT, H_WEIGHT, H_BLOOD_GROUP, H_VACCINE, H_DISABILITY, H_HEALTH_CONDITION, H_ALLERGY, D_DOCTOR_ID);
